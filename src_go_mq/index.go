...
func Handler(ctx context.Context, event *MessageQueueEvent) (*Response, error) {

	// получить апдейт (JSON-строка) из сообщения MessageQueue
	rawUpdate := event.MessagesQueue[0].Details.Message.Body

	// распарсить JSON-строку в models.Update
